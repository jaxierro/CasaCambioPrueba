$( document ).ready(function () {
    ...
    $("#btnConfirmar").click(function () {
        ...
        var id = $("#int_local_id").val();
        var familia = $("#local_nombre").val();
...
function editar(id)
{
    ...
    $.ajax({
        ...
        success: function (data) {
            $('#bodyForm').html(data);
            $('#FormModal').modal({ show: tru﻿$( document ).ready(function () {
