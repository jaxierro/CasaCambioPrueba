...
*/
CKEDITOR.plugins.setLang("codesnippet","uk",{button:"Вставити фрагмент коду",codeContents:"Код",emptySnippetError:"Фрагмент коду не можи бути порожнім.",language:"Мова",title:"Фрагмент коду",pathName:"фраг�/*
 Copyright (c) 2003-2018, CKSource - Frederico Knabben. All rights reserved.
 For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
*/
